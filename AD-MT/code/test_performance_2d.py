...
parser.add_argument('--root_path', type=str, default='./data/ACDC', help='Patch to dataset')
parser.add_argument('--res_path', type=str, default='./results', help='Path to results')
parser.add_argument('--exp', type=str, default='ACDC/POST-NoT', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "{}/{}_{}_labeled/{}".format(FLAGS.res_path, FLAGS.exp, 
